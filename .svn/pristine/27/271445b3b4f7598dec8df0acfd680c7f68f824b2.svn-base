...
public class PaymentRequestStrategy extends CommonRequest4Icbc<ICBCRequestFundsDTO> {
    ...
    protected void getData() throws BzException {
        ...
        String loanPeriod = applyMain.getArzqx();
        ...
        //还款方式
        paymentInfo.setLoantype(codeConvert("ahkfs", payType));
        //融资期限
        paymentInfo.setLoanterm(loanPeriod);
        //外部交易流水号
        paymentInfo.setExtxnseq(serialNumberUtil.getTranNo4Idfactory(IcbcConstant.TRAN_BIZCODE, IcbcConstant.TRAN_SYSCODE));
