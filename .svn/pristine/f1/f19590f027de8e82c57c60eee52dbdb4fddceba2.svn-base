...
public class DscOwnServiceImpl implements DscOwnService {
    ...
    @Resource
    private YTRequestDataHandle ynRequestDataHandle;
...
//				`updator_id`, `updator_name`, `version`s
	 ...
	 */
	@Override
	public BaseMsgDTO YNTrustMaintenance(YNTrustMaintenanceDTO maintenanceDto) {
		return ynRequestDataHandle.maintenance(maintenanceDto);
	}
}
