...
public class FirstTrialCallback{
	...
	public String execute(String weBankjson) {
		...
		if(assetMainInfo != null){
			...
			if(APS_STATUS.SUCC.equals(calbackDto.getApsStatus()) && StringUtils.isNotBlank(calbackDto.getApsCode())
					&& calbackDto.getApsCode().contains(CommonConstant.WB_RESP_CODE)){
