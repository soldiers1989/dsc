...
public class GetContractFileRequestStrategy extends AbstractBaseDealDomain<AssetContractTask,BaseMsgDTO>{
    ...
    protected InvokeResult<BaseMsgDTO> message() throws BzException {
        ...
        logger.info("\n订单号{}云信获取合同签署状态及内容请求报文为{},请求路径为{}",
                task.getApplyNo(),bankTran.getReqBody(),url);
        ...
        logger.info("\n订单号{}云信获取合同签署状态接口返回报文为{}",
                task.getApplyNo(),result);

        BaseMsgDTO baseMsgDTO = BaseMsgDTO.processData("签章进行中");
